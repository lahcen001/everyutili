...
export default function PngToJpg() {
  ...
  const convertAll = async () => {
    ...
    for (const item of pending) {
      ...
      if (result.status === "success") {
        await saveToolResult("png-to-jpg", {
  ...
  return (
    <div className="space-y-6">
      <DropZone
        ...
        hint="Batch convert transparent PNGs to compact JPG files"
      />
      ...
      <ToolHistoryList ref={historyRef} toolSlug="png-to-jpg" />
    </div>
  );
}
