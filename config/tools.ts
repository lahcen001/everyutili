...
export const TOOLS: ToolConfig[] = [
  ...
  // ---------------------------------------------------------------------
  {
    ...
    icon: Users,
    name: "Team Generator",
    shortName: "Team Generator",
    relatedSlugs: ["random-name-picker", "list-shuffler"],
    priority: 0.7,
    changeFrequency: "monthly",
  },
  {
  ...
  },
  {
    ...
    shortName: "Name Picker",
    relatedSlugs: ["team-generator", "wheel-spinner"],
    ssr: false,
    priority: 0.71,
    changeFrequency: "monthly",
  },
  {
    ...
    shortName: "Number Generator",
    relatedSlugs: ["dice-roller", "coin-flip"],
    ssr: false,
    priority: 0.68,
    changeFrequency: "monthly",
  },
  {
    ...
    shortName: "Yes/No Decider",
    relatedSlugs: ["coin-flip", "wheel-spinner"],
    ssr: false,
    priority: 0.65,
    changeFrequency: "monthly",
  },
  {
    ...
    name: "Coin Flip",
    shortName: "Coin Flip",
    relatedSlugs: ["dice-roller", "yes-no-decision-maker"],
    ssr: false,
    priority: 0.67,
    changeFrequency: "monthly",
  },
  {
    ...
    relatedSlugs: ["coin-flip", "random-number-generator"],
    ssr: false,
    priority: 0.66,
    changeFrequency: "monthly",
  },
  {
    ...
    shortName: "List Shuffler",
    relatedSlugs: ["team-generator", "random-name-picker"],
    priority: 0.64,
    changeFrequency: "monthly",
  },
  {
    ...
    shortName: "Bracket Generator",
    relatedSlugs: ["team-generator", "list-shuffler"],
    priority: 0.6,
    changeFrequency: "monthly",
  },
  {
    ...
    category: "random-decision",
    icon: Ticket,
    name: "Raffle & Giveaway Picker",
    shortName: "Raffle Picker",
    relatedSlugs: ["random-name-picker", "wheel-spinner"],
    ssr: false,
    priority: 0.63,
    changeFrequency: "monthly",
  },
