...
export default function SvgToJpg() {
  ...
  const convertAll = async () => {
    ...
    for (const item of pending) {
      ...
      if (result.status === "success") {
        await saveToolResult("svg-to-jpg", {
  ...
  return (
    <div className="space-y-6">
      <DropZone
        ...
        hint="Batch rasterize vector icons and illustrations to JPG — transparent areas become white"
      />
      ...
      <ToolHistoryList ref={historyRef} toolSlug="svg-to-jpg" />
    </div>
  );
}
