...
export default function WebpToJpg() {
  ...
  const convertAll = async () => {
    ...
    for (const item of pending) {
      ...
      if (result.status === "success") {
        await saveToolResult("webp-to-jpg", {
  ...
  return (
    <div className="space-y-6">
      <DropZone
        ...
        hint="Batch convert to JPG — transparent areas become white"
      />
      ...
      <ToolHistoryList ref={historyRef} toolSlug="webp-to-jpg" />
    </div>
  );
}
