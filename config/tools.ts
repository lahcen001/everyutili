...
export const TOOLS: ToolConfig[] = [
  ...
  },
  {
    ...
    relatedSlugs: ["loan-emi-calculator", "compound-interest-calculator"],
    priority: 0.86,
    changeFrequency: "monthly",
  },
  {
    ...
    relatedSlugs: ["compound-interest-calculator", "loan-emi-calculator"],
    priority: 0.7,
    changeFrequency: "monthly",
  },
  {
  ...
  },
  {
    ...
    relatedSlugs: ["compound-interest-calculator", "mortgage-calculator"],
    priority: 0.74,
    changeFrequency: "monthly",
  },
  {
    ...
    shortName: "Paycheck Calculator",
    relatedSlugs: ["salary-to-hourly", "sales-tax-calculator"],
    priority: 0.8,
    changeFrequency: "monthly",
  },
